  ...
  },
  {
    ...
    behaviors: {
      nodes: {
        ...
        VISION: { kind: 'periodic', period_ms: 150 },
        VISION_Q: { kind: 'queue', capacity: 4, policy: 'reject', drain_ms: 400 },
        ...
        TELEM_RING: { kind: 'queue', capacity: 10, policy: 'drop_oldest', drain_ms: 250 },
    ...
    devices: [
      {
        ...
        label: 'Program feed',
        initial: 0.5,
        hint: 'slide to 1.0 and the segment queue fills until it back-pressures the planner; to 0 and it starves',
      },
      {
        kind: 'gauge',
      ...
      },
      {
        ...
        source: 'depth',
        max: 10,
        hint: 'drops oldest when full: blocking the RT tier is worse than losing a sample',
      },
    ],
  },
  {
    ...
    devices: [
      ...
      },
      {
        ...
        source: 'depth',
        max: 8,
        hint: 'a slow client leaks its own frames and never back-pressures the shared encoder',
      },
    ],
  },
  {
